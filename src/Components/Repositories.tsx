...
const Repositories = () => {
    ...
    if (isLoading) {
        return <><div role="status">
            <svg aria-hidden="true" className="w-8 h-8 mr-2 mb-16 text-gray-200 animate-spin dark:text-gray-600 fill-indigo-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
